...
public class WebViewContainer extends Fragment {
    ...
    private ControlFullScreen controlFullScreen;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //adapterLayoutContainer = view.findViewById(R.id.adapter_layout_dummy);
        ...
        webView.setWebChromeClient(new WebChromeClient(){
            ...
            public void onShowCustomView(View view, CustomViewCallback callback) {
                ...
                if(controlFullScreen != null)
                    controlFullScreen.goFullScreen(view, callback);
                //adapterLayoutContainer.requestFocus();
            }
            ...
            public void onHideCustomView() {
                ...
                if (controlFullScreen != null)
                    controlFullScreen.exitFullScreen();
            }
        });
    ...
    /*
    overrides the onResume method, and calls the webview onResume to stop every html5, javascript processing
     */
    @Override
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof ControlFullScreen)
            controlFullScreen = (ControlFullScreen) context;
    }
    ...
    interface ControlFullScreen{
        void goFullScreen(View v, WebChromeClient.CustomViewCallback callback);
